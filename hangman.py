...
# Iss function ko test karne ke liye aap get_guessed_word("kindness", [k, n, d]) call  sakte hai
...
def hangman(secret_word):
  ...
  user_difficulty_choice=input("which level you want play?\na)easy\nb)medium\nc)hard\n\na, b, c which level you want: ")
